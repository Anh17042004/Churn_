...
# streamlit app
st.title("Dự đoán tỉ lệ khách hàng rời bỏ")
...
is_activate_member = st.selectbox("Is Active Member", [0, 1])
...
st.write(f"Xác suất: {prediction_proba}")

if prediction_proba > 0.5:
  st.write("Khách hàng có khả năng rời khỏi ngân hàng")
else:
  st.write("Khách hàng không có khả năng rời khỏi ngân hàng")
